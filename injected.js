...
var readability = {
    ...
    regexps: {
        ...
        nextLink:              /(next|weiter|continue|>([^\|]|$)|Âť([^\|]|$))/i, // Match: next, continue, >, >>, Âť but not >|, Âť| as those usually mean last.
        prevLink:              /(prev|earl|old|new|<|ÂŤ)/i
    },
        ...
        **/
        for(i = 0, il = allLinks.length; i < il; i++) {
            ...
            **/
            ...
            if(linkData.match(/(first|last)/i)) { // -65 is enough to negate any bonuses gotten from a > or Âť in the text, 
